                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            ...
                            <p>{{$data['course']->cat->name}}<span>/</span>Courses<span>/</span>{{$data['course']->name}}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image mb-5">
                        <img src="{{asset('uplouds/courses/' . $data['course']->img)}}" class="special_img" alt="">
                    </div>
                    <div class="content_wrapper mb-5">
                        {!! $data['course']->desc  !!}
                        ...
                        <ul>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Trainer’s Name</p>
                                    <span class="color">{{$data['course']->trainer->name}}</span>
                                </a>
                            </li>
                            <li>
                                <a class="justify-content-between d-flex" href="#">
                                    <p>Course Fee </p>
                                    <span>${{$data['course']->price}}</span>
                                </a>
                            </li>                           
                        </ul>                   
                    </div>
